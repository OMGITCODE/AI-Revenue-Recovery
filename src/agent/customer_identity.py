    ...
    def _seed_archetypes(self):
        ...
        archetypes = [
            CustomerProfile(
                ...
                customer_ids={"cust-sbi-001", "cust-spike-007", "cust_rahul_01"},
                vpas={"rahul@oksbi"},
                phones={"+919800000001"},
                emails={"rahul.sharma@example.com"},
                aliases={"cust:rahul@oksbi", "cust-sbi-001", "cust-spike-007", "cust_rahul_01", "rahul@oksbi", "+919800000001", "rahul.sharma@example.com"},
            ),
            CustomerProfile(
                canonical_id="cust:priya@okhdfcbank",
                primary_name="Priya Patel",
                customer_ids={"cust-hdfc-002", "cust_priya_02"},
                vpas={"priya@okhdfcbank"},
                phones={"+919800000002"},
                emails={"priya.patel@example.com"},
                aliases={"cust:priya@okhdfcbank", "cust-hdfc-002", "cust_priya_02", "priya@okhdfcbank", "+919800000002", "priya.patel@example.com"},
            ),
            CustomerProfile(
                canonical_id="cust:arjun@okicici",
                primary_name="Arjun Mehta",
                customer_ids={"cust-arjun-003", "cust-normal-008", "cust_arjun_03"},
                vpas={"arjun@okicici"},
                phones={"+919800000003"},
                emails={"arjun.mehta@example.com"},
                aliases={"cust:arjun@okicici", "cust-arjun-003", "cust-normal-008", "cust_arjun_03", "arjun@okicici", "+919800000003", "arjun.mehta@example.com"},
            ),
            CustomerProfile(
                canonical_id="cust:meera@okaxis",
                primary_name="Meera Iyer",
                customer_ids={"cust-axis-004", "cust_meera_04"},
                vpas={"meera@okaxis"},
                phones={"+919800000004"},
                emails={"meera.iyer@example.com"},
                aliases={"cust:meera@okaxis", "cust-axis-004", "cust_meera_04", "meera@okaxis", "+919800000004", "meera.iyer@example.com"},
            ),
            CustomerProfile(
                canonical_id="cust:vikram@ybl",
                primary_name="Vikram Singh",
                customer_ids={"cust-ybl-005", "cust_vikram_05"},
                vpas={"vikram@ybl"},
                phones={"+919800000005"},
                emails={"vikram.singh@example.com"},
                aliases={"cust:vikram@ybl", "cust-ybl-005", "cust_vikram_05", "vikram@ybl", "+919800000005", "vikram.singh@example.com"},
            ),
            CustomerProfile(
